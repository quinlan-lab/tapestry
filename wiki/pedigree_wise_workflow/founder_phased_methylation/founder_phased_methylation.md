...
- **Inheritance-based phasing** (Step 1B, `gtg-ped-map` +
  ...
  - The **iht-phased VCF**, which phases each het variant as `p|m`
    ...
    [`get_iht_phasing`](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/phasing_pedigree.py#L99)
    (called from
    [`phase_meth_to_founder_haps.py:29`](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/phase_meth_to_founder_haps.py#L29)).
  - The **iht-blocks table** ([`df_iht_blocks`](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/phase_meth_to_founder_haps.py#L32)), which assigns one of the pedigree's
...
the bit-vector comparison in [`get_hap_map`](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/hap_map_pedigree.py#L13),
specifically the `similarity_hap1_pat > 0.5` branch at
[line 58](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/hap_map_pedigree.py#L58); the
function is called from
[`phase_meth_to_founder_haps.py:208`](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/phase_meth_to_founder_haps.py#L208).
...
([`aligned_bam_to_cpg_scores.sh`](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/aligned_bam_to_cpg_scores.sh#L1))
...
[`phase_meth_to_founder_haps`](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/phase_meth_to_founder_haps.py#L44)
(called once per pb-CpG-tools mode at
[line 236](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/phase_meth_to_founder_haps.py#L236)
and
[line 238](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/phase_meth_to_founder_haps.py#L238)),
...
1. **`hap1`/`hap2` → `pat`/`mat`.** The bit-vector decision recorded
   ...
   ([lines 71–103](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/phase_meth_to_founder_haps.py#L71)).
2. **`pat`/`mat` → founder letter.** The founder-haplotype letter
   ...
   ([lines 104–105](https://github.com/quinlan-lab/tapestry/blob/37af86d041294f9e029a477475bc68d5ab743af2/src/phase_meth_to_founder_haps.py#L104)).
