...
meth_count_read_phased_dir="/scratch/ucgd/lustre-labs/quinlan/data-shared/dna-methylation/CEPH1463.GRCh38.hifi.count.read-backed-phased" # output dir of aligned_bam_to_cpg_scores in count mode 
meth_model_read_phased_dir="/scratch/ucgd/lustre-labs/quinlan/data-shared/dna-methylation/CEPH1463.GRCh38.hifi.model.read-backed-phased" # output dir of aligned_bam_to_cpg_scores in model mode 
