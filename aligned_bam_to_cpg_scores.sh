...
palladium_bed_dir="/scratch/ucgd/lustre-labs/quinlan/data-shared/dna-methylation/CEPH1463.GRCh38.hifi.${PB_CPG_TOOL_MODE}.read-backed-phased" 

mkdir -p ${palladium_bed_dir}
...
for prefix in $prefixes; do
    nohup aligned_bam_to_cpg_scores \
        ...
        --output-prefix ${palladium_bed_dir}/${prefix}.GRCh38.haplotagged \
        --threads 8 \
        --min-coverage 10 \
        --min-mapq 1 \
        --pileup-mode ${PB_CPG_TOOL_MODE} \
        > ${palladium_bed_dir}/${prefix}.2.log 2>&1 &
    echo "Started ${prefix}"
done
